  ...
  return (
    ...
    >
      ...
      {completed ? (
        ...
        <Text style={[styles.demoNote, { color: colors.textMuted }]}>
          Read the scenario, rate the action, then study the breakdown — that's where the method is taught.
        </Text>
      )}
    </View>
  );
      ...
      <View style={styles.modalOverlay}>
        ...
        >
          ...
          <Text style={[styles.modalBody, { color: colors.textSecondary }]}>
            You've finished every SJ lesson. Now put your skills to the test with practice scenarios or a timed exam.
          </Text>
          ...
          >
            ...
            <Text style={styles.modalBtnText}>Practice Scenarios</Text>
          </TouchableOpacity>
...
export default function SituationalJudgementLessonScreen({ navigation, route }) {
  ...
  // example (lesson id is written to AsyncStorage from SJScenarioScreen on
  ...
  const launchTutorDemo = useCallback(() => {
    ...
    navigation.navigate('SJScenario', { mode: 'tutorDemo' });
  }, [demoLaunchIndex, handleQuestionAnswered, navigation]);

  const launchWorkedExample = useCallback(() => {
    navigation.navigate('SJScenario', { mode: 'workedExample', exampleId: lesson.id });
  ...
  const goToNextLesson = useCallback(() => {
    if (nextLesson) {
      navigation.replace('LearnSJLesson', { lessonId: nextLesson.id });
      return;
    }
    openPractice();
  ...
  return (
    <PremiumScreen>
      ...
      <AppHeader navigation={navigation} title="SJ Lesson" />
      ...
      >
        ...
        <View style={styles.actionStack}>
          <PrimaryButton
            label={nextLesson ? 'Continue to Next Lesson' : 'Start SJ Practice'}
          ...
          {prevLesson ? (
            <PrimaryButton
              ...
              variant="outline"
              onPress={() => navigation.replace('LearnSJLesson', { lessonId: prevLesson.id })}
            />
          ) : null}
        </View>
      </PremiumScrollView>
