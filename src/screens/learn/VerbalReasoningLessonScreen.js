      ...
      <View style={styles.modalOverlay}>
        ...
        >
          ...
          <Text style={[styles.modalBody, { color: colors.textSecondary }]}>
            You've finished every VR lesson. Now put your skills to the test with practice questions or a timed exam.
          </Text>
...
export default function VerbalReasoningLessonScreen({ navigation, route }) {
  ...
  return (
    <PremiumScreen>
      ...
      <AppHeader navigation={navigation} title="VR Lesson" />
      ...
      >
        ...
        <View style={styles.actionStack}>
          <PrimaryButton
            label={nextLesson ? 'Continue to Next Lesson' : 'Start VR Practice'}
          ...
          {prevLesson ? (
            <PrimaryButton
              ...
              variant="outline"
              onPress={() => navigation.replace('LearnVRLesson', { lessonId: prevLesson.id })}
            />
          ) : null}
        </View>
      </PremiumScrollView>
