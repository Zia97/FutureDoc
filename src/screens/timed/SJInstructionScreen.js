...
export default function SJInstructionScreen({ navigation, route }) {
  ...
  const startTest = () => {
    ...
    navigation.replace('TimedSJTest', { test, section, title });
  };
  ...
  return (
    <View style={[styles.container, { backgroundColor: t.bgInput }]}>
      ...
      <View style={[styles.header, { backgroundColor: t.headerBg }]}>
        <Text style={styles.headerTitle}>Situational Judgement</Text>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={[styles.sectionTitle, { color: t.text }]}>
          SITUATIONAL JUDGEMENT INSTRUCTIONS
        </Text>
        ...
        <View style={[styles.table, { borderColor: t.border }]}>
          ...
          <View style={[styles.tableRow, { borderBottomWidth: 0, backgroundColor: t.bgCard }]}>
            <View style={[styles.dataCell, { flex: 3, borderRightColor: t.border }]}>
              <Text style={[styles.dataCellText, { color: t.text, fontWeight: '700' }]}>Situational Judgement</Text>
            </View>
            <View style={[styles.dataCell, { flex: 2, borderRightColor: t.border }]}>
              <Text style={[styles.dataCellText, { color: t.text, textAlign: 'center', fontWeight: '600' }]}>69</Text>
            </View>
