...
-- Fixes data loss caused by migration 007 which deleted all tests instead of only test_id = 1.
-- label_set: 1 = importance scale, 2 = appropriateness scale

-- Clear existing Test 2 data only (questions first due to FK, then scenarios)
